...
export const SERVICES_HUB_GROUPS = [
  {
    ...
    links: [
      ...
      { label: 'Gutter Maintenance', href: '/products-services/gutter-maintenance-denver-co/' },
      { label: 'Gutter Inspection', href: '/products-services/gutter-inspection-services-denver-co/' },
    ],
  },
  {
    ...
    links: [
      ...
      { label: 'Custom Gutters', href: '/products-services/custom-gutters-denver-co/' },
      { label: 'Residential Gutters', href: '/products-services/residential-gutters-denver-co/' },
      { label: 'Commercial Gutters', href: '/products-services/commercial-gutters-denver-co/' },
    ],
  },
  {
    title: 'Gutter Materials',
    links: [
  ...
  {
    title: 'Gutter Protection & Roofline',
    links: [
      { label: 'Gutter Guards', href: '/products-services/denver-gutter-guards-co/' },
      { label: 'Snow Guards', href: '/products-services/gutter-snow-guard-denver-co/' },
      { label: 'Heat Tape', href: '/products-services/snow-ice-solutions-heat-tape-denver-co/' },
      { label: 'Fascia and Soffit Repair', href: '/products-services/denver-fascia-soffit-repair-co/' },
    ],
  },
  {
